...
write_csv(wide_monthly_tdiff, path = "data/wide_monthly_tdiff.csv")
write_csv(monthly_tdiff, path = "data/long_monthly_tdiff.csv")

write_csv(british_weather, path = "data/british_weather.csv")
